...
public class Application {
    ...
    /* 설명.
     *  bean scope란?
     *   스프링 bean이 생성될 때 해당 인스턴스의 범위를 의미한다. 스프링에서는 다양한 bean scope를 제공한다
     *   1. singleton     : 하나의 인스턴스만을 생성하고, 모든 bean이 해당 인스턴스를 공유하여 사용한다
    ...
    * */
    public static void main(String[] args) {
        ...
        /* 설명. 붕어빵, 딸기우유, 지리산암반수 bean 객체를 반환 받아 변수에 담는다 */
